    ...
    override func receive(strData: String) {
        do {
            if strData.contains("event")
            {
                ...
                iceServers.append(RTCIceServer(urlStrings: ["turn:103.238.210.193:3478"], username: "test", credential: "test"))//                iceServers.append(RTCIceServer(urlStrings:["stun:stun.l.google.com:19302"] ))
